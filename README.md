...
This project contains source code and some core example data for the paper titled "How to quantify an examination? Evidence from physics examinations via complex networks".
